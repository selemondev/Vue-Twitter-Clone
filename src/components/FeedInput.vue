    ...
    <div class="w-full divide-y dark:divide-gray-800 divide-gray-800">
        ...
        <div class="flex justify-between items-center pt-2">
            ...
            <div class="icon-style">
             ...
             <div>
                <button :disabled="!inputEl" class="bg-[#1d9bf0] text-white rounded-full shadow-md hover:bg-[#1a8cd8] disabled:hover:bg-[#1d9bf0] disabled:opacity-50 disabled:cursor-default px-4 py-1.5 font-bold" @click="sendTweet()">Tweet</button>
              </div>
        </div>
        </div>
    </div>
